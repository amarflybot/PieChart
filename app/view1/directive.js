        ...
        var slices,
            ...
            getArc = function(startAngle, endAngle) {
                ...
                function getPointOnCircle(angle) {
                    return {
                        x: Math.round(radius * Math.cos(angle)) + 200,
                        y: Math.round(radius * Math.sin(angle)) + 200
                    };
                };
    ...
    .directive('piechartSlice', ['piechartConfig', 'createSVGNode', '$compile', function(piechartConfig, createSVGNode, $compile) {
        return {
            ...
            link: function(scope, element, attrs, ctrl) {
                ...
                var d = 'M200,200L{{arc.start.x}},{{arc.start.y}}A{{radius}},{{radius}},1,{{value > (totalValue / 2) ? 1 : 0}},1,{{arc.end.x}},{{arc.end.y}}Z';
